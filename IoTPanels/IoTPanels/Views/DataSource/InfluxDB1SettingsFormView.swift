...
struct InfluxDB1SettingsFormView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("InfluxDB 1 Settings")
    }
    ...
    private func discoverDatabases() {
        ...
        let service = InfluxDB1Service(url: normalizedUrl, database: "", username: username, password: password)
        Task {
            do {
